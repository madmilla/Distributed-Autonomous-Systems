 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calcws/", wsdlLocation = "file:/D:/ontw_omg/workspaces_2012/disy_workspace/503_Calculator_WS_Client2/resources/saved.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/ontw_omg/workspaces_2012/disy_workspace/503_Calculator_WS_Client2/resources/saved.wsdl");
