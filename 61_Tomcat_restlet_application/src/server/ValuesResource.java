...
public class ValuesResource extends ServerResource {  
	...
	@Get("json")
	public JsonRepresentation getJson(Representation entity) throws Exception 
	{
	...
	@Get("xml")
	public DomRepresentation getXml(Representation entity) throws Exception 
	{
	...
	@Post
    public void doIt(StringRepresentation entity) throws Exception 
    {
